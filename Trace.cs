...

{
...

    {
        ...
        public void UpdateTargets(int state, List<IGestureListener> targets)

        {
...

            {
                ...
                if (!targets.Contains(target)) // can be optimized
            ...
            else if (state == (int)TuioCursor.States.del)
            ...
            m_group.UpdateTargets(this, state);
